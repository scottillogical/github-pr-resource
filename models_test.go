...
func TestSource(t *testing.T) {
	tests := []struct {
		...
		{
			description: "requires the GitHub App configuration values",
			source: resource.Source{
				Repository:   "test/test",
				UseGitHubApp: true,
				PrivateKey:   "key.pem",
			...
			wantErr: "private_key, application_id and installation_id must be set if using GitHub App authentication",
		},
		{
